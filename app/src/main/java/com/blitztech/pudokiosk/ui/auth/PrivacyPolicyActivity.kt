...
class PrivacyPolicyActivity : BaseKioskActivity() {
...
We may update these Terms of Service from time to time. Changes will be posted in the app, and your continued use constitutes acceptance of the new terms.
    ...
    private fun navigateToTermsConditions() {
        val intent = Intent(this, TermsConditionsActivity::class.java).apply {
            putExtra(TermsConditionsActivity.EXTRA_FORM_DATA, formData)
            putExtra(TermsConditionsActivity.EXTRA_USER_TYPE, userType.name)
        }
