...
class SignUpActivity : BaseKioskActivity() {
    ...
    private fun navigateToPrivacyPolicy() {
        ...
        val formData = SignUpFormData(
            ...
            mobileNumber = ValidationUtils.formatPhoneNumber(binding.etMobileNumber.text.toString().trim()),
            nationalId = ValidationUtils.formatNationalId(binding.etNationalId.text.toString().trim()),
